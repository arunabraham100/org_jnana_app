    ...
    .directive('tangCloud', ['$interpolate', '$compile', '$timeout', function ($interpolate, $compile, $timeout) {
        ...
        var directive = {
            ...
            template: function (tElement, tAttrs) {
                ...
                var clickAttr = isClickable ? 'ng-click="ngclick({word : entry.word, id : entry.id})"' : 'true';

                return "<div class='tangcloud'>" +
                    "<span ng-repeat='entry in words' ng-class='{clearance: entry.size>=11, new: entry.size>=50}'" + clickAttr + ">{{entry.word}}</span>" +
                    "</div>";
            },
            ...
            compile: function (elem) {
                ...
                return function (scope, elem) {
                    ...
                    function addSpanPositionStyling(span, startX, startY) {
                        var style = 'position: absolute; left:' + startX + 'px !important; top: ' + startY + 'px !important;';
